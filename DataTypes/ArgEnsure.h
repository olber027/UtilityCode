...
public:
    ...
    template<typename T>
    explicit IntegerArgument(const T& shortopt) : Argument(shortopt, "", false) {}
...
public:
    ...
    template<typename T>
    explicit DecimalArgument(const T& shortopt) : Argument(shortopt, "", false) {}
...
public:
    ...
    template<typename T>
    explicit FlagArgument(const T& shortopt) : Argument(shortopt, "", false) {}
